                ...
                return (
                  <div key={status} className="bg-[#1E293B]/40 border border-slate-800/80 rounded-2xl p-4 flex flex-col min-h-[500px]">
                    ...
                    {isLoading ? (
                      ...
                      <div className="space-y-3 flex-1 overflow-y-auto max-h-[70vh] scrollbar-thin scrollbar-thumb-slate-800">
                        {columnTasks.length === 0 ? (
                          ...
                          columnTasks.map((task) => (
                            <div
                              key={task._id}
                              className="bg-[#1E293B] border border-slate-850 rounded-xl p-4 hover:border-[#06B6D4]/50 transition-all duration-200 shadow-sm flex flex-col justify-between min-h-[220px] group"
                            >
                              <div>
                                <div className="flex items-start justify-between gap-2">
                                  ...
                                  <span className={`text-[10px] px-2 py-0.5 rounded border ${getPriorityStyles(task.priority)} font-semibold shrink-0`}>
                                    {task.priority}
                                  </span>
                                </div>
                                ...
                                <div className="flex flex-wrap gap-1">
                                  {ALL_STATUSES.filter((s) => s !== task.status).map((targetStatus) => (
                                    <button
                                      ...
                                      className="text-[9px] bg-slate-800 hover:bg-[#06B6D4]/10 text-slate-300 hover:text-[#06B6D4] px-1.5 py-0.5 rounded border border-slate-700/80 hover:border-[#06B6D4]/30 transition-all cursor-pointer"
                                    >
                                      {targetStatus}
                                    </button>
                                  ))}
                              ...
                              <div className="flex items-center justify-between mt-4 pt-3 border-t border-slate-850/60">
                                ...
                                <button
                                  ...
                                  className="text-[10px] font-bold text-[#06B6D4] hover:text-white px-2 py-1.5 rounded bg-[#06B6D4]/5 hover:bg-[#06B6D4] transition-all cursor-pointer"
                                >
                                  Details
                                </button>
                              </div>
    ...
    lg:self-start lg:sticky lg:top-6 lg:h-[calc(100vh-3rem)]`}
                ...
                <div className="border-t border-slate-800 p-3 space-y-3 bg-[#1E293B]/90">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    <button
                      ...
                      className="text-[9px] font-bold text-slate-300 hover:text-white px-2 py-1 rounded bg-[#0B0F19] border border-slate-800 hover:border-[#06B6D4] transition-all cursor-pointer"
                    >
      ...
      {selectedTask && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#0B0F19]/80 backdrop-blur-sm animate-fade-in">
          <div className="bg-[#1E293B] border border-slate-800 rounded-2xl w-full max-w-2xl overflow-hidden shadow-2xl">
            {/* Modal Header */}
