...
function FeatureCard({ icon, title, description, delay = 0 }: FeatureCardProps) {
    return (
        <AnimatedCard
            delay={delay}
            className="relative group overflow-hidden rounded-2xl bg-slate-900/40 border border-slate-800/80 p-8 hover:border-cyan-500/30 hover:bg-slate-900/60 transition-colors duration-300 shadow-xl"
        >
    ...
    return (
        <section id="features" className="py-24 bg-[#0B0F19] relative">
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                {/* Feature Grid — staggered via individual delays */}
