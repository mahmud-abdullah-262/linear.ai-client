                        ...
                        {steps.map((step) => {
                            ...
                            return (
                                <div
                                    ...
                                    className={`cursor-pointer rounded-2xl p-6 border transition-all duration-300 ${isSelected
                                ...
                                >
                                    <div className="flex items-center gap-3 mb-2">
                                        <span
                                            className={`text-xs font-bold px-2.5 py-0.5 rounded-full border ${isSelected
